...
- Browse entries as a list or a photo grid, and jump straight to a date with the calendar picker in the header
- An hours summary — total hours this week or this month, broken down by site
- Works offline: entries created, edited, or deleted without a connection are queued on-device and synced automatically once you're back online, with a pending indicator until they do
